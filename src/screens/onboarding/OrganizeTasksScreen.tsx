  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>Organize Tasks</Text>
        <Text style={styles.subtitle}>Plan your day and never miss important things.</Text>
        ...
        <View style={styles.actions}>
          <PrimaryButton title="Next" onPress={() => navigation.navigate('TrackExpenses')} />
        </View>
      </View>
    </SafeAreaView>
  );
